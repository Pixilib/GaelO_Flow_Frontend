    ...
    return (
        <div className="flex flex-col gap-3">
            ...
            <div className="flex justify-end gap-5">
                <Button data-gaelo-flow="retrieve-buttonPlay" onClick={() => mutateResumeQueue({})} color={Colors.success}><Play /></Button>
                <Button data-gaelo-flow="retrieve-buttonPause" onClick={() => mutatePauseQueue({})} color={Colors.primary}><Pause /></Button>
                <Button data-gaelo-flow="retrieve-buttonDelete" onClick={() => mutateDeleteQueue({})} color={Colors.danger}><Trash /></Button>
            </div>
        </div>
    )
}
