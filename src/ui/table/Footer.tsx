...
const Footer = ({ table }: FooterProps) => {
  ...
  return (
    <div className="flex items-center justify-between flex-grow bg-white border-t-2 border-gray-200 rounded shadow-lg">
        <div>
        ...
        <div className="flex space-x-2">
          <button 
            className="bg-transparent focus:outline-none text-dark"
